(function () {
    ...
    // Audio
    var runSound = new Audio("desert/audio/run.mp3"); runSound.loop = true;
    var jumSound = new Audio("desert/audio/jump.mp3");
    var deadSound = new Audio("desert/audio/dead.mp3");
